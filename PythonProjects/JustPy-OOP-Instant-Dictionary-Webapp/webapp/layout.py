...
class DefaultLayout(jp.QLayout):
    ...
    def __init__(self, view="hHh lpR fFf", **kwargs):
        ...
        nav_btn_classes = "p-2 m-2 text-lg text-blue-400 hover:text-blue-700"
        jp.A(a=qlist, text="Home", href="/", classes=nav_btn_classes)
        jp.Br(a=qlist)
        jp.A(a=qlist, text="About", href="/about", classes=nav_btn_classes)
        jp.Br(a=qlist)
        jp.A(a=qlist, text="Dictionary", href="/dictionary", classes=nav_btn_classes)
        jp.Br(a=qlist)
